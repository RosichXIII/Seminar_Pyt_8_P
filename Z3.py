...
class Cell:
    ...
    def __sub__(self, other):
        if (self.quantity - other.quantity) > 0:
            return f'Разность = {(self.quantity - other.quantity)}'
        return f'Ошибка - отрицательная разность.'
...
print(f'{cell_2 + cell_1}\n')
print(f'{cell_4 - cell_2}\n')
print(f'{cell_5 - cell_2}\n')
print(f'{cell_5 / cell_2}\n')
print(f'{cell_2 * cell_3}\n')
print(Cell.make_order(cell_2, 21))